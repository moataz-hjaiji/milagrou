...
exports.updatePosition = exports.remove = exports.update = exports.getOne = exports.getAll = exports.create = void 0;
...
exports.create = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    const result = await product_1.default.create({ body, files });
...
exports.getAll = (0, asyncHandler_1.default)(async (req, res) => {
    ...
    new ApiResponse_1.SuccessResponsePaginate('All products returned successfully', result.docs, result.meta).send(res);
});
...
exports.update = (0, asyncHandler_1.default)(async (req, res) => {
    const { id } = req.params;
    const { body, files } = req;
    const result = await product_1.default.update({ id, body, files });
...
exports.updatePosition = (0, asyncHandler_1.default)(async (req, res) => {
    const { body } = req;
    await product_1.default.updatePosition(body);
    new ApiResponse_1.SuccessMsgResponse('Products updated').send(res);
});
