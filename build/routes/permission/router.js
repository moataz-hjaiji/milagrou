...
router
    .route('/')
    .get((0, assignAction_1.default)({ action: seed_permission_1.ACTIONS.list, entity: 'Permission' }), authorization_1.default, permissionController.getAll);
router
    .route('/:id')
    .get((0, assignAction_1.default)({ action: seed_permission_1.ACTIONS.read, entity: 'Permission' }), authorization_1.default, (0, validator_1.default)(schema_1.default.param, validator_1.ValidationSource.PARAM), permissionController.getOne);
